package com.capstone.medigo.domain.fetchmydata.service;
...
public class MyDataService {
    private final MyDataYamlRead myDataYamlRead;

    public String crypto(String regNum) throws Exception {
        AES256 aes256 = new AES256(myDataYamlRead.getAes256Alg(), myDataYamlRead.getAes256Key(), myDataYamlRead.getAes256Iv());
    ...
    public HashMap<String, Object> connectToMyData(String encryptJumin, String userEmail, String access_Token) {
        ...
        String Token = myDataYamlRead.getMyDataToken();
        ...
        try {
            ...
            jsonBody.addProperty( "USERNAME",myDataYamlRead.getTestName());
            jsonBody.addProperty( "HPNUMBER",myDataYamlRead.getTestPhone());
